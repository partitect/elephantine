...
- ?? **100% CPU???????**: AVX-512 SIMD????????ONNX Runtime????2 vCPU??????????35ms???????????????
- ?? **??????????????**: Git???????????????workspace_id???????????????????????????????????
- ?? **???????????**: ??????????????????????????????**???????????**?
ole_authority???????????????????????
- ?? **????WebUI???????**: ???????????????????????????????????????/dashboard??
- ?? **??????GGUF SLM??**: ??LLM?????????????????llama-cpp-python?Qwen2.5-0.5B-Instruct????????????????
- ?? **??????????????????**: ??-??-??????????????/graph/query??????????????
- ?? **????????????????**: ??????????????????????????????
...
???? **Ubuntu 24.04 VDS (2 vCPU / 4 GB RAM, GPU??)** ???????
